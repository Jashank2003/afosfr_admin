...
const Livecard = ({ orderId, name, order, amount ,dailycount }) => {
  ...
  return (
    ...
    <>
    <div className="  bg-[#161616]  py-1 pb-3 px-3 my-2 mx-4 rounded-lg shadow  w-[15vw] h-[38vh]">
    <span className=" text-white font-bold absolute rounded-2xl bg-red-400 w-7 h-7 p-0.5  text-center  -mx-4 -my-1">{dailycount}</span>
    ...
    <div className="bg-black p-0.5 rounded shadow ">
        ...
        <div className="h-[12vh]">
            ...
            {/* <p className="text-white px-2 p-1">1* pizza</p> */}
